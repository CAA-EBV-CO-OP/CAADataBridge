# DataBridge UI - Extracted from CAADataBridge/ui.R
# Lines 297-1329 (main app content, excluding login/chooser/nav bar)
# All input/output IDs should be wrapped in ns() for module namespacing
# NOTE: ns() wrapping is applied via find-replace after initial extraction

#' DataBridge UI Content
#' @param ns Namespace function from NS(id)
#' @return Shiny UI tagList
databridge_ui_content <- function(ns) {
  tagList(
    ...
    # Main app content
        ...
        tags$div(
          ...
          tags$div(
            ...
            materialSwitch(ns("dark_mode"), NULL, value = TRUE, status = "primary", inline = TRUE),
      ...
      tags$input(id = ns("last_selected_column"), type = "hidden", value = ""),
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          tags$div(
            ...
            checkboxInput(ns("use_destination_schema"), "Use destination schema", value = FALSE),
            tags$div(
              id = ns("dest_schema_controls"),
              ...
              actionLink(ns("clear_destination_schema"), "Clear destination schema")
            ),
            uiOutput(ns("destination_schema_status"))
          )
        ),
        ...
        mainPanel(
          fluidRow(
            ...
            column(4,
              div(style = "margin-top: 15px; text-align: right;",
                actionBttn(ns("refresh_badges"), "Refresh Mappings",
          ...
          tags$div(
            ...
            tags$div(
              ...
              uiOutput(ns("classification_summary_badge"))
            ),
            tags$div(
              ...
              fluidRow(
                column(4,
                  selectInput(
                    ns("classification_filter_class"),
                    "Filter by Class:",
                    choices = c(
                      "All Classes" = "all",
                      "Class 1 (Essential)" = "1",
                ...
                column(8,
                  tags$div(
                    ...
                    actionBttn(ns("apply_bulk_class3"), "Low-Value → 3",
                              style = "bordered", color = "warning", size = "sm",
                              icon = icon("arrow-down")),
                    actionBttn(ns("apply_bulk_class4"), "PII/Internal → 4",
                    ...
                    actionBttn(ns("set_selected_class1"), "1",
                              style = "bordered", color = "success", size = "sm"),
                    actionBttn(ns("set_selected_class2"), "2",
                              style = "bordered", color = "primary", size = "sm"),
                    actionBttn(ns("set_selected_class3"), "3",
                              style = "bordered", color = "warning", size = "sm"),
                    actionBttn(ns("set_selected_class4"), "4",
                              style = "bordered", color = "danger", size = "sm")
                  )
                )
              ),
              DT::dataTableOutput(ns("classification_table")),
              tags$div(
          ...
          div(
            ...
            div(
              ...
              div(
                ...
                actionButton(ns("accept_all_class3"), "Accept All Class 3",
          ...
          fluidRow(
            column(6,
              actionBttn(ns("update_unmapped"), "Update Unmapped Columns",
          ...
          uiOutput(ns("unmapped_columns_ui")),
          uiOutput(ns("unused_target_fields_ui")),
          div(
            style = "margin: 20px 0 10px;",
            checkboxInput(
              ns("keep_merged_sources"),
          ...
          hr(),
          fluidRow(
            column(3, actionBttn(ns("show_mappings"), "Show All Mappings", style = "fill", color = "primary")),
            column(3, actionBttn(ns("apply_mappings"), "Apply Mappings & Finalize", style = "fill", color = "success")),
            column(3,
              downloadButton(ns("download_mapped"), "Download Mapped CSV", class = "btn-primary", icon = icon("download"))
            ),
            column(
              3,
              ...
              tags$div(
                ...
                checkboxInput(
                  ns("restrict_to_destination_only"),
              ...
              checkboxInput(ns("embed_build_info"), "Embed mapper build info in output", value = TRUE),
              checkboxInput(
                ns("include_derived_metrics"),
                sprintf(
          ...
          tags$div(
            ...
            plotOutput(ns("sales_scatter_plot"), height = "500px")
          ),
          ...
          tags$div(
            ...
            plotOutput(ns("price_distribution_plot"), height = "400px")
          ),
          ...
          tags$div(
            ...
            plotOutput(ns("price_by_neighborhood_plot"), height = "500px")
          ),
          ...
          tags$div(
            ...
            plotOutput(ns("sales_volume_plot"), height = "400px")
          ),
          ...
          tags$div(
            ...
            plotOutput(ns("price_per_sqft_plot"), height = "500px")
          ),
          ...
          tags$div(
            ...
            plotOutput(ns("price_per_sqft_vs_sqft_plot"), height = "500px")
          ),
          ...
          tags$div(
            ...
            plotOutput(ns("price_by_bedrooms_plot"), height = "500px")
          ),
